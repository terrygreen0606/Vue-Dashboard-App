<template>
  <div
    id="chartdiv-working-hours-map"
    class="working-map"
    :class="{'working-sm-and-down': $vuetify.breakpoint.smAndDown, 'working-sm-and-up': $vuetify.breakpoint.smAndUp }"
  />
</template>
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.$nextTick(() => {
        this.container = am4core.create('chartdiv-working-hours-map', am4core.Container)
        ...
        var mapChart = this.container.createChild(am4maps.MapChart)
        var button = mapChart.createChild(am4core.SwitchButton)
        button.align = 'right'
        button.marginTop = 0
        ...
        try {
          mapChart.geodata = am4geodataContinentsLow
        } catch (e) {
        ...
        */
        ...
        nineLabel.fill = am4core.color('#00A3E4')
        nineLabel.text = '~9 AM'
        ...
        function solarPosition (time) {
          ...
          var longitude = ((am4core.time.round(new Date(time), 'day', 1).getTime() - time - offset) / 864e5) * 360 - 180
        ...
        var slider = this.container.createChild(am4core.Slider)
        slider.start = 0.5
        ...
        function solarApparentLongitude (centuries) {
          return (
            ...
            (0.00569 + 0.00478 * Math.sin((125.04 - 1934.136 * centuries) * am4core.math.RADIANS)) * am4core.math.RADIANS
          )
        }
        ...
        function obliquityCorrection (centuries) {
          return (
            ...
            0.00256 *
            Math.cos((125.04 - 1934.136 * centuries) * am4core.math.RADIANS) *
            am4core.math.RADIANS
          )
        }
